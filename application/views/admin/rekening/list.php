        ...
        foreach ($rekening as $rekening) { ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url('admin/rekening/delete/' . $rekening->id_rekening) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Hapus Data?')">
